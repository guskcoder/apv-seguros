        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Veja o que as pessoas estão falando sobre nossa plataforma de seguros
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-secondary rounded-full flex items-center justify-center font-bold text-gray-900 text-xl">
                  M
                </div>
                <div className="ml-4">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 text-sm">Curitiba, PR</p>
                </div>
              </div>
              <p className="text-gray-600 leading-relaxed">
